...
L["Accept Raid Chat"] = true
L["accept_raid_chat_desc"] = "Enables players to send their current item(s) via raid chat to you to get added to the voting frame."
...
L["auto_award_announce_desc"] = "Whether auto awarded items should be announced."
L["Autoloot BoE"] = true
...
L["Should Announce Auto Award"] = true
